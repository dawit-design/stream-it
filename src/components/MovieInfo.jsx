  ...
  return (
    <div className="movie-cont">
      ...
      <div className="movie-info">
        ...
        <h5 >Description: {description ? description : "Black Panther is a 2018 American superhero film based on the Marvel Comics character of the same name. Produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures, it is the 18th film in the Marvel Cinematic Universe (MCU)"}</h5>
